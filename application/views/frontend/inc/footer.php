                    ...
                    <div class="f-item">
                        ...
                        <div class="social">
                            <ul>
                                ...
                                <li>
                                    <a href="#"><i class="fab fa-google-plus-g"></i></a>                                    </li>
                                <li>
                                    <a href="#"><i class="fab fa-dribbble"></i></a>                                    </li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="f-item link">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#">Forums</a>                                </li>
                            <li>
                                <a href="#">Language Packs</a>                                </li>
                            <li>
                                <a href="#">Release Status</a>                                </li>
                            <li>
                                <a href="#">LearnPress</a>                                </li>
                            <li>
                    ...
                    <div class="f-item recent-post">
                        ...
                        <ul>
                            <li>
                                <div class="thumb">
                                    <a href="#">
                                        <img src="<?=base_url()?>assets/frontend/img/courses/g1.jpg" alt="Thumb">                                        </a>                                    </div>
                                <div class="info">
                                    <a href="#">Subjects allied to Creative arts and design</a>
                                    <div class="meta-title">
                                        <span class="post-date">12 Feb, 2018</span> - By <a href="#">Jessica</a>                                        </div>
                                </div>
                            </li>
                            <li>
                                <div class="thumb">
                                    <a href="#">
                                        <img src="<?=base_url()?>assets/frontend/img/courses/g2.jpg" alt="Thumb">                                        </a>                                    </div>
                                <div class="info">
                                    <a href="#">Business and administrative subjects</a>
                                    <div class="meta-title">
                                        <span class="post-date">12 Feb, 2018</span> - By <a href="#">Arnold</a>                                        </div>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="footer-bottom bg-transparent">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-8">
                        <p>@copyright 2019. All rights reserved by Global Health Alliance, UK <a href="http://spidersofweb.com">   &nbsp;Spiders Of Web</a></p>
                    </div>
